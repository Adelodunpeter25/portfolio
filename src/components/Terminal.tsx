...
const commands: Record<string, string[]> = {
  ...
  projects: [
    ...
    '    processing, task automation, and intelligent conversation',
    '    capabilities. Streamlines daily workflows through text-based',
    '    commands with features like task management, web search,',
    '    note-taking, and smart reminders.',
