...
const commands: Record<string, string[]> = {
  ...
  projects: [
    ...
    '',
    '[2] GitCLI',
    '    The thinking man\'s approach to Git. A user-friendly',
    '    command-line tool that simplifies everyday operations.',
    '    Powerful Git functionality without the complexity.',
    '    Tech: Python',
    '    → https://github.com/Adelodunpeter25/GitCLI',
    '',
    '[3] Resumade',
    '    Thoughtfully designed. A modern resume builder with',
